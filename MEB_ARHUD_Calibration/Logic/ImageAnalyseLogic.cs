...
namespace MEB_ARHUD_Calibration.Logic
{
    class ImageAnalyseLogic
    {
        ...
        public List<PointF> TestGetCircleForCalibration(string fileName)
        {
        ...
        private List<MyContour> GetAllContours(Image<Gray, byte> image)
        {
        ...
        private List<MyContour> GetCalibrationBorderContours(List<MyContour> list_Contour_All)
        {
            List<MyContour> list_MyContour = new List<MyContour>();
        ...
        private List<MyContour> GetCalibrationContours(List<MyContour> list_Contour_All, Rectangle rect)
        {
            List<MyContour> list_MyContour = new List<MyContour>();
        ...
        private Rectangle GetMaxRectForBorder(List<MyContour> list_Contour)
        {
        ...
        private void TestGetCircle_Analyse(Image<Gray, byte> image_Src)
        {
            ...
            {
                int X_ImageCenter = ImageWidth / 2 + Config.Camera_MoveX[Config.ProjectType] + Config.Camera_OffsetX[Config.ProjectType];
                int Y_ImageCenter = ImageHeight / 2 + Config.Camera_MoveY[Config.ProjectType] + Config.Camera_OffsetY[Config.ProjectType];
        ...
        {
            int moveX = center.X - (ImageAnalyseLogic.ImageWidth / 2 + Config.Camera_MoveX[Config.ProjectType]);
            int moveY = center.Y - (ImageAnalyseLogic.ImageHeight / 2 + Config.Camera_MoveY[Config.ProjectType]);
        ...
        private bool CheckIsCircle(MyContour myContour, double minArea)
        {
